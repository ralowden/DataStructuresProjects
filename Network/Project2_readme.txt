                        ...
                        Interface design due in lab April 4
...
Getting started:  Copy the Project 2 materials by starting from oncourse 
"SP13 BL CSCI C343 16422 Resources".

Suggested Timeline (if you want to finish on time)
==================
Design the classes, modules, and interfaces (see "Teamwork").      April 4
Have working code for the easier modules.                          April 11
Have working code for identifying a network; progress on search.   April 18
Finish project.                                                    April 25
...
the minimax algorithm for searching game trees, described in Lecture 6.
...
in Lecture 6.  Alpha-beta search is a technique for "pruning" a game tree, so
...
Lecture 6 pseudocode, the more likely you are to succeed.
...
have the code that identifies legal moves implemented by April 11, I advise you
...
Teamwork (10% of project grade) (show to your AI in Lab 7, April 4)
========
...
You should have a draft of your GRADER file ready to show your AI in Lab 7
(April 4).  Your Lab 7 score depends on having a finished draft of your
modules and interfaces.  Your AI will comment on your design decisions.

You may change some of your design decisions based on your AI's feedback, and
...
statement.  This statement is due in Lab 10 on April 25.  You will not receive 
a grade if you don't turn it in.
...
project should always be submitted by the same student. If you've submitted 
your project once, or even written a substantial amount of code together, you 
may not change partners without the permission of the instructor.
...
your MachinePlayer.java and other Java files. You're not allowed to change 
Move.java and Player.java. You may also submit other packages in your pj2 directory 
(e.g. a list package). Compress your pj2 directory as "pj2" and submit it to onCourse.
